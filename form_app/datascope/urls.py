...
urlpatterns = [
    ...
    path("submit-form-admin/<slug:username>", views.submit_form_admin, name="submit-form-admin"),
    path("submit-form-course/<slug:username>", views.submit_form_course, name="submit-form-course"),
